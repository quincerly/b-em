...
void multicore_launch_core1_with_stack(int (*entry)(void), uint32_t *stack_bottom, size_t stack_size_bytes);
void multicore_sleep_core1();
void multicore_launch_core1_raw(int (*entry)(void), uint32_t *sp, uint32_t vector_table);
